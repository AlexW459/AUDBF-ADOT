...
function BC = con_BC( plane)
    ...
    plane.battery.required_capacity2 = plane.cruise_properties.power2*...
        ...
        plane.battery.voltage + plane.motor.power_max*...                   %Assuming that you initially fly at max power for 20 seconds for TO/landing
        20/60*...
        1.25*plane.units.W2mW*plane.units.min2h/...
        plane.battery.voltage;
    %For mission 3 we fly X laps in 5 minutes
