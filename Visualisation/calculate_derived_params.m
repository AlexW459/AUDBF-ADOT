...
function [derived_parameters, derived_param_names] = calculate_derived_params(...
    ...
    motor_length = motor_table{motor_index, 3};
    ...
    wing_base_sweep = (wing_base_length/wing_length)*wing_sweep+wing_root_chord*(1-wing_base_scale);
    ...
    derived_param_names = ...
        ...
        "wing_base_sweep", "motor_pod_length", "motor_width", "motor_length", "motor_mass", ...
