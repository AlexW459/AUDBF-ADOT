...
function transformations = vertical_stabiliser_right_constraint(parameters, param_names, der_params, der_param_names)
    
    rod_width = der_params(find(strcmp(der_param_names, "empennage_rod_width")));
    ...
    xPos = rod_width*0.25;
    yPos = 0;
    zPos = -0.5*vertical_stabiliser_chord;
